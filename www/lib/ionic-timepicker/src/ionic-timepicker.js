    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        element.on("click", function () {
          ...
          var obj = {epochTime: scope.etime, step: 1, format: scope.format};
          ...
          scope.increaseHours = function () {
            scope.timestamp = scope.timestamp + 3600;
          ...
          scope.increaseMinutes = function () {
            ...
            scope.timestamp = scope.timestamp + 60;
              ...
              buttons: [
                ...
                },
                {
                  ...
                  onTap: function (e) {
                    ...
                    window.localStorage['timeDiff'] = scope.timestamp;
